...
The code for reproducing the research is contained in `04_code` using the authentication dataset from https://csr.lanl.gov/data/cyber1/. It is structured as follows: 
